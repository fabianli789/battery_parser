...
Nomad parser for Meysams Battery SEI simulations
...
```sh
git clone https://github.com/fabianli789/battery_parser.git
cd battery_parser
...
```sh
pip install dist/battery_parser-0.1.0
```
